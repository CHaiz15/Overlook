...
describe('Hotel:', () => {
  ...
  describe('Default Values:', () => {
    it('should store todays date', function() {
      expect(hotel.todaysDate).to.equal("2020/02/04");
    });
  ...
  describe('Method Values:', () => {
    ...
    it('should find all rooms booked today', function() {
    ...
    it('should calculate todays revenue', function() {
